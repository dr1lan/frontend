(function($){$.reject=function(options){var opts=$.extend(!0,{reject:{all:!1,msie:6},display:[],browserShow:!0,browserInfo:{chrome:{text:'Google Chrome',url:'//www.google.com/chrome/'},firefox:{text:'Mozilla Firefox',url:'//www.mozilla.com/firefox/'},safari:{text:'Safari',url:'//www.apple.com/safari/download/'},opera:{text:'Opera',url:'//www.opera.com/download/'},msie:{text:'Internet Explorer',url:'//www.microsoft.com/windows/Internet-explorer/'},msedge:{text:'Microsoft Edge',url:'//www.microsoft.com/ru-ru/windows/microsoft-edge'}},header:'Did you know that your Internet Browser is out of date?',paragraph1:'Your browser is out of date, and may not be compatible with '+'our website. A list of the most popular web browsers can be '+'found below.',paragraph2:'Just click on the icons to get to the download page',close:!0,closeMessage:'By closing this window you acknowledge that your experience '+'on this website may be degraded',closeLink:'Close This Window',closeURL:'#',closeESC:!0,closeCookie:!1,cookieSettings:{path:'/',expires:0},imagePath:'./images/',overlayBgColor:'#000',overlayOpacity:0.95,fadeInTime:'fast',fadeOutTime:'fast',analytics:!1},options);if(opts.display.length<1){opts.display=['chrome','firefox','safari','opera','msie','msedge']}
    ...
    if(opts.close&&opts.closeCookie){var COOKIE_NAME='jreject-close';var _cookie=function(name,value){if(typeof value!='undefined'){var expires='';if(opts.cookieSettings.expires!==0){var date=new Date();date.setTime(date.getTime()+(opts.cookieSettings.expires*1000));expires="; expires="+date.toGMTString()}
        var path=opts.cookieSettings.path||'/';document.cookie=name+'='+encodeURIComponent((!value)?'':value)+expires+'; path='+path;return!0}
    ...
    var html='<div id="jr_overlay"></div><div id="jr_wrap"><div id="jr_inner">'+'<h1 id="jr_header">'+opts.header+'</h1>'+(opts.paragraph1===''?'':'<p>'+opts.paragraph1+'</p>')+(opts.paragraph2===''?'':'<p>'+opts.paragraph2+'</p>');var displayNum=0;if(opts.browserShow){html+='<ul>';for(var x in opts.display){var browser=opts.display[x];var info=opts.browserInfo[browser]||!1;if(!info||(info.allow!=undefined&&!browserCheck(info.allow))){continue}
    ...
    return r},c=function(i,a,b,c){var r={name:m((a.exec(i)||[u,u])[1],b)};r[r.name]=!0;if(!r.opera){r.version=(c.exec(i)||[x,x,x,x])[3]}
