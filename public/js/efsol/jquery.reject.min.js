        ...
        $.reject = function(options) {
            var opts = $.extend(!0, {
                ...
                browserInfo: {
                    ...
                    msedge: {
                        text: 'Microsoft Edge',
                        url: '//www.microsoft.com/ru-ru/windows/microsoft-edge'
                    }
                },
            ...
            if (opts.display.length < 1) {
                opts.display = ['chrome', 'firefox', 'safari', 'opera', 'msie', 'msedge']
            }
            ...
            if (opts.browserShow) {
                ...
                for (var x in opts.display) {
                    ...
                    var info = opts.browserInfo[browser] || !1;
...
(function($) {
    $.browserTest = function(a, z) {
        ...
        $.browser = $.extend((!z) ? $.browser : {}, c(a, /(camino|chrome|crios|firefox|netscape|konqueror|lynx|msie|trident|opera|safari)/, [['trident', 'msie']], /(camino|chrome|crios|firefox|netscape|netscape6|opera|version|konqueror|lynx|msie|rv|safari)(:|\/|\s)([a-z0-9\.\+]*?)(\;|dev|rel|\s|$)/));
        $.layout = c(a, /(gecko|konqueror|msie|trident|opera|webkit)/, [['konqueror', 'khtml'], ['msie', 'trident'], ['opera', 'presto']], /(applewebkit|rv|konqueror|msie)(\:|\/|\s)([a-z0-9\.]*?)(\;|\)|\s)/);
        $.os = {
